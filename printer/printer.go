...
func (p *printer) internalError(msg ...interface{}) {
	if debug {
		...
		fmt.Println(msg...)
		panic("github.com/hokkaido/gopp/printer")
	}
}
...
func (p *printer) print(args ...interface{}) {
	for _, arg := range args {
		...
		default:
			...
			panic("github.com/hokkaido/gopp/printer type")
		}
		// data != ""
...
unsupported:
	return fmt.Errorf("github.com/hokkaido/gopp/printer: unsupported node type %T", node)
}
